...
grid_image_path = create_grid_image(canvas_width, canvas_height, grid_size_px)
...
canvas_data = st_canvas(
    ...
    background_image=Image.open(grid_image_path),
